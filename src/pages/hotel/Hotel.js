      ...
      <div>
        ...
        <div className="flex justify-center mt-6">
          <div className="w-full max-w-5xl flex flex-col gap-2 relative ">
            <button className="absolute top-3 right-0 bg-[#1f214d] p-1 text-white outline-none font-medium rounded">
              Reserve or Book Now!
            </button>
            ...
            <div className="grid grid-cols-4 gap-5 mt-5">
              ...
              <div className="col-span-1 bg-slate-300 p-2 gap-3">
                ...
                <button className="bg-[#1f214d] p-1 text-white outline-none font-medium rounded w-full">
                  Reserve or Book Now!
                </button>
              </div>
            </div>
